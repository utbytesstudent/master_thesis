...
def generate_sequence_logo(df, output_dir, output_file, organism_name, sigma_id, motif, width, sites, p_value, percentage_sites, median_start, dataset_description, ic_value):
    ...
    # --- Removed elements ---
    # Removed title
    # Removed subtitle (dataset_description)
    # Removed text box with p-value, sites, and IC
...
base_directory = "/cluster/home/zacharis/output/meme/larger_motifs/sigma70p/"
output_directory = "/cluster/home/zacharis/output/final_plots/clean/large_motifs/sigma70p"
